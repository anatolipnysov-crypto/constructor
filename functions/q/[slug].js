...
function pageHeaders(version) {
  return {
    ...
    'content-security-policy': [
      "default-src 'none'",
      "script-src 'unsafe-inline' https://mc.yandex.ru",
      "connect-src https://api.atmospace.pro https://mc.yandex.ru https://*.mc.yandex.ru",
      "img-src data: https://mc.yandex.ru https://*.mc.yandex.ru",
      "style-src 'unsafe-inline'",
      "font-src data:",
      "frame-ancestors 'none'",
      "base-uri 'none'",
      "form-action https://atmospace.pro https://*.atmospace.pro",
    ].join('; '),
