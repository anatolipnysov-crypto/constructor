...
import { MODERNISTO_FORMAT_ONE_HERO_DATA_URI } from './modernistoFormatOne';

export const MODERNISTO_FORMAT_ONE_VISUAL_VARIANTS = Object.freeze([
  Object.freeze({
    id: 'midnight-blue',
    label: 'Контрастный синий',
    heroDataUri: MODERNISTO_FORMAT_ONE_HERO_DATA_URI
  }),
  Object.freeze({
    id: 'daylight-blue',
...
#atmosfera-30-landing{--a30l-photo-x:53%;--a30l-photo-y:22%;--a30l-photo-mobile-x:51%;--a30l-photo-mobile-y:17%;--a30l-photo-filter:saturate(.8) contrast(1.08) brightness(.83)}
